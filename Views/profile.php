         ...
         <div class='delete'>
           <?php if ($view_user['id'] == $view_requested_user['id']) : ?>
            ...
            <form action="profile.php" method="post">
                <input type="hidden" name='tweet_id' value="<?php echo htmlspecialchars($view_tweet['tweet_id']);?>">
            <a href='../Controllers/profile.php'><button class="delete" type="submit">削除</button></a>
            </form>
            <?php endif;?>
